...
The model made incorrect predictions in many, many areas.  I was hoping that I could I would be able to point out specific notable recurring errors like in my previous courses, but in this case, it is barely beating the baseline.  I *do*, however, have some hypotheses.

First, I think that I must do some more tokenization of the data.  When I printed out examples of tweets, many of them contained web links and such which I imagine could have confused the system.  On a website like Twitter, where people are constantly sharing links, that could be a major factor.  I could see Twitter handles (like @ExampleTwitterHandle) being a factor too, among other things.

Second, since the model is barely above the baseline, it needs to be fit much more tightly.  Going forward, I would like to design a version of this program that can run much more intensive calculations (with a much more user friendly and configurable level of customization).  See Future Improvements for more on that.
