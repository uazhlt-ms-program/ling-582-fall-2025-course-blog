...
In this project, we build a Retrieval-Augmented Generation (RAG) system for question answering on the HotpotQA dataset. Here we use an embedding model and FAISS to retrieve the most relevent chunks from a corpus built from HotpotQA. Then we send the question along with the retrieved chunks to an LLM to generate an answer.
