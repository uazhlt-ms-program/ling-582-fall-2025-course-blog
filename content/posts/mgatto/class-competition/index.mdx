...
I assert that word-order and sentence structure are in fact important for authorthis attribution as the above experiment implies. Thus, I hypothesize thar a RNN with a long-memory will perform better. Because I believe long memories are important here, CNNs are not appropriate for this specific type of classification tasks.
