...
I realized early on that most or all of the data come from what appear to be fictional stories. For example:
```Python-repl
>>> df["TEXT1"][100]
...
```
I was also interested in how long these text snippets generally were, both in terms of characters and words. 
...
Classification Report:
           ...
           0       0.79      0.98      0.88       484
           1       0.97      0.76      0.85       512

    accuracy                           0.87       996
   macro avg       0.88      0.87      0.86       996
weighted avg       0.89      0.87      0.86       996
```
...
Steps for reproducing my results can be found in my code repository's README [here](https://github.com/uazhlt-ms-program/ling-582-fall-2025-class-competition-code-tschnoor).
