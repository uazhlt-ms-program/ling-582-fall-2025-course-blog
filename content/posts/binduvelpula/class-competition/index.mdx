...
- Dataset was shuffled; the order of snippets shouldn’t affect predictions.  
...
## Modeling Approach
flowchart LR
A[Input Snippet Pair] --> B[TF-IDF Features]
A --> C[BERT Tokenization & Embedding]
B --> D[TF-IDF Logistic Regression]
C --> E[BERT Fine-Tuning]
D --> F[Ensemble Averaging]
E --> F[Ensemble Averaging]
