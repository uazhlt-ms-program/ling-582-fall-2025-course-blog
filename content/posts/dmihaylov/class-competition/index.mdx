...
<p>I looked through a number of samples to understand the range of writing styles. Some examples were long paragraphs while others were only a few lines which suggested that length alone wouldn't be a wholey reliable feature. I also checked the class distribution and found more 0 labels than 1 labels, which meant that the dataset was somewhat imbalanced.
...
<p>To run this approach, implement the following commands in bash/terminal:
```
