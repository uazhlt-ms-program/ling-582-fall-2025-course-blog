...
[README.md](https://github.com/uazhlt-ms-program/ling-582-fall-2025-class-competition-code-bess-days/blob/main/README.md) - I showed reproducibility and I set up seeds for the files, along with how to run the model.
